...
class ProductController extends CommonController {
    ...
    public function index() {
        ...
        $list = D('Product')->get_product_list($filter, $offset);
    ...
    public function insert(){
        ...
        */
        ...
        {
            // model('Admin')->admin_log($goods_id, 'add', 'product');
    ...
    public function update(){
        ...
        {
            //model('Admin')->admin_log($id, 'edit', 'product');
    ...
    function query(){
        ...
        $list = D('Product')->get_product_list($filter, $page->firstRow.','.$page->listRows);
        $this->assign('list', $list);
    ...
    public function operate(){
        ...
        elseif('remove' == $act){            
            if ($this->drop($id))
            {
                //model('Admin')->admin_log($id,'remove','product');
                clear_cache_files();
            }
            return $this->query();
        }
