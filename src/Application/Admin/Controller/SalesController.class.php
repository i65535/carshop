...
class SalesController extends CommonController {
    ...
    public function insert(){
        ...
        */
        ...
        {
            // model('Admin')->admin_log($goods_id, 'add', 'sales');
    ...
    function query(){
        ...
        $list = D('Sales')->get_sales_list($filter, $page->firstRow.','.$page->listRows);
        $this->assign('list', $list);
        ...
        make_json_result($this->display('sales_index', true), '', array('filter' => $filter['page']));
    }
