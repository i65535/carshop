...
class IdcController extends CommonController {
    ...
    public function index() {
        ...
        $list = D('Idc')->get_idc_list($filter, $offset);
    ...
    public function insert(){
        ...
        */
        ...
        {
            // model('Admin')->admin_log($goods_id, 'add', 'idc');
    ...
    function query(){
        ...
        $list = D('Idc')->get_idc_list($filter, $page->firstRow.','.$page->listRows);
        $this->assign('list', $list);
        ...
        make_json_result($this->display('idc_index', true), '', array('filter' => $filter['page']));
    }
    ...
    public function operate(){
        ...
        elseif('remove' == $act){            
            if ($this->drop($id))
            {
                //model('Admin')->admin_log($id,'remove','idc');
                clear_cache_files();
            }
            return $this->query();
        }
